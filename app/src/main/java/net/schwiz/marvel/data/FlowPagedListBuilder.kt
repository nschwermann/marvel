package net.schwiz.marvel.data
/*
 ...
 *
 * Taken from https://github.com/chrisbanes/tivi/blob/master/data-android/src/main/java/app/tivi/data/FlowPagedListBuilder.kt
 */
